...
export const routes: Routes = [
  ...
  { path: 'dashboard/lawlibrary', component: DashboardComponent, canActivate: [adminGuard] },
  { path: 'dashboard/lawfact', component: DashboardComponent, canActivate: [adminGuard] },
  { path: 'dashboard/lawspeak', component: DashboardComponent, canActivate: [adminGuard]},
  { path: 'dashboard/lawbot', component: DashboardComponent, canActivate: [adminGuard]},
